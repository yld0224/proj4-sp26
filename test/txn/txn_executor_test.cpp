...
TEST(TxnExecutorTest, DISABLED_InsertTest)
{  // NOLINT
  ...
  WithTxn(txn1,
          ExecuteTxn(*bustub, _var, _txn, "INSERT INTO maintable VALUES (1)"));
  WithTxn(txn2,
          ExecuteTxn(*bustub, _var, _txn, "INSERT INTO maintable VALUES (2)"));

  TxnMgrDbg("after insertion", bustub->txn_manager_.get(), table_info,
...
TEST(TxnExecutorTest, DISABLED_InsertCommitTest)
{  // NOLINT
  auto bustub = std::make_unique<BustubInstance>();
  Execute(*bustub, "CREATE TABLE maintable(a int)");
  auto table_info = bustub->catalog_->GetTable("maintable");
  ...
  TxnMgrDbg("after commit txn1", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  ...
  WithTxn(txn2, QueryShowResult(*bustub, _var, _txn, query, IntResult{{2}}));
  WithTxn(txn3,
          ExecuteTxn(*bustub, _var, _txn, "INSERT INTO maintable VALUES (3)"));
  TxnMgrDbg("after insert into txn3", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  fmt::println(stderr, "E: check scan txn3");
  WithTxn(txn3,
          QueryShowResult(*bustub, _var, _txn, query, IntResult{{1}, {3}}));
  fmt::println(stderr, "F: check scan txn2");
  WithTxn(txn2, QueryShowResult(*bustub, _var, _txn, query, IntResult{{2}}));
  WithTxn(txn3, CommitTxn(*bustub, _var, _txn));
  WithTxn(txn2, CommitTxn(*bustub, _var, _txn));
  TxnMgrDbg("after commit txn2", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
...
TEST(TxnExecutorTest, DISABLED_InsertDeleteTest)
{  // NOLINT
  auto bustub = std::make_unique<BustubInstance>();
  auto empty_table = IntResult{};
  Execute(*bustub, "CREATE TABLE maintable(a int)");
  ...
  WithTxn(txn1,
          ExecuteTxn(*bustub, _var, _txn, "INSERT INTO maintable VALUES (3)"));
  WithTxn(txn1,
          ExecuteTxn(*bustub, _var, _txn, "DELETE FROM maintable WHERE a = 3"));
  TxnMgrDbg("after 3 insert + 1 delete", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  fmt::println(stderr, "A: check scan txn1");
  const auto query = "SELECT a FROM maintable";
  WithTxn(txn1,
          QueryShowResult(*bustub, _var, _txn, query, IntResult{{1}, {2}}));
  WithTxn(txn1, CommitTxn(*bustub, _var, _txn));
  TxnMgrDbg("after commit", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  auto txn_ref = BeginTxn(*bustub, "txn_ref");
  auto txn2 = BeginTxn(*bustub, "txn2");
  fmt::println(stderr, "B: check scan txn2");
  WithTxn(txn2,
          QueryShowResult(*bustub, _var, _txn, query, IntResult{{1}, {2}}));
  WithTxn(txn2,
          ExecuteTxn(*bustub, _var, _txn, "DELETE FROM maintable WHERE a = 2"));
  TxnMgrDbg("after txn2 delete", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  ...
  WithTxn(txn4,
          QueryShowResult(*bustub, _var, _txn, query, IntResult{{1}, {2}}));
  WithTxn(txn4,
          ExecuteTxn(*bustub, _var, _txn, "INSERT INTO maintable VALUES (4)"));
  WithTxn(txn4,
          ExecuteTxn(*bustub, _var, _txn, "INSERT INTO maintable VALUES (5)"));
  WithTxn(txn4,
          ExecuteTxn(*bustub, _var, _txn, "INSERT INTO maintable VALUES (6)"));
  WithTxn(txn4,
          ExecuteTxn(*bustub, _var, _txn, "DELETE FROM maintable WHERE a = 6"));
  TxnMgrDbg("after txn4 modification", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  ...
  WithTxn(txn2, QueryShowResult(*bustub, _var, _txn, query, IntResult{{1}}));
  WithTxn(txn2,
          ExecuteTxn(*bustub, _var, _txn, "DELETE FROM maintable WHERE a = 5"));
  WithTxn(txn2, QueryShowResult(*bustub, _var, _txn, query, IntResult{{1}}));
  WithTxn(txn2, CommitTxn(*bustub, _var, _txn));
  WithTxn(txn4, CommitTxn(*bustub, _var, _txn));
  TxnMgrDbg("after commit", bustub->txn_manager_.get(), table_info,
...
{  // NOLINT
  ...
  WithTxn(txn3, ExecuteTxnTainted(*bustub, _var, _txn,
                                  "DELETE FROM maintable WHERE a = 2"));
  TxnMgrDbg("after txn3 tainted", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  auto txn4 = BeginTxn(*bustub, "txn4");
  ...
  WithTxn(txn6,
          ExecuteTxn(*bustub, _var, _txn, "DELETE FROM maintable WHERE a = 5"));
  TxnMgrDbg("after txn6 deletes", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  WithTxn(txn6, CommitTxn(*bustub, _var, _txn));
  TxnMgrDbg("after txn6 commits", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  fmt::println(stderr, "J: taint txn5");
  WithTxn(txn5, ExecuteTxnTainted(*bustub, _var, _txn,
                                  "DELETE FROM maintable WHERE a = 5"));
  auto txn7 = BeginTxn(*bustub, "txn7");
  fmt::println(stderr, "I: check scan txn7");
  WithTxn(txn7,
          QueryShowResult(*bustub, _var, _txn, query, IntResult{{1}, {4}}));
...
TEST(TxnExecutorTest, DISABLED_UpdateTest1)
{  // NOLINT
  ...
  auto txn_ref = BeginTxn(*bustub, "txn_ref");
  auto txn1 = BeginTxn(*bustub, "txn1");
  WithTxn(txn1, ExecuteTxn(*bustub, _var, _txn,
                           "INSERT INTO table1 VALUES (1, 1, 1)"));
  TxnMgrDbg("after insert", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  ...
  TxnMgrDbg("after update", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  WithTxn(txn1,
          QueryShowResult(*bustub, _var, _txn, query, IntResult{{1, 2, 1}}));
  WithTxn(txn_ref, QueryShowResult(*bustub, _var, _txn, query, empty_table));
  ...
  TxnMgrDbg("after update", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  WithTxn(txn1,
          QueryShowResult(*bustub, _var, _txn, query, IntResult{{1, 3, 1}}));
  WithTxn(txn_ref, QueryShowResult(*bustub, _var, _txn, query, empty_table));
  WithTxn(txn1, CheckUndoLogNum(*bustub, _var, _txn, 0));
  ...
  TxnMgrDbg("after update", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  WithTxn(txn1,
          QueryShowResult(*bustub, _var, _txn, query, IntResult{{2, 3, 1}}));
  WithTxn(txn_ref, QueryShowResult(*bustub, _var, _txn, query, empty_table));
  WithTxn(txn1, CheckUndoLogNum(*bustub, _var, _txn, 0));
  ...
  TxnMgrDbg("after update", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  WithTxn(txn1,
          QueryShowResult(*bustub, _var, _txn, query, IntResult{{2, 1, 1}}));
  WithTxn(txn_ref, QueryShowResult(*bustub, _var, _txn, query, empty_table));
  WithTxn(txn1, CheckUndoLogNum(*bustub, _var, _txn, 0));
  ...
  TxnMgrDbg("after update", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  WithTxn(txn1,
          QueryShowResult(*bustub, _var, _txn, query, IntResult{{3, 1, 1}}));
  WithTxn(txn_ref, QueryShowResult(*bustub, _var, _txn, query, empty_table));
  WithTxn(txn1, CheckUndoLogNum(*bustub, _var, _txn, 0));
  fmt::println(stderr, "F: 6th update");
  WithTxn(txn1, ExecuteTxn(*bustub, _var, _txn,
                           "UPDATE table1 SET a = 4, b = 4, c = 4"));
  TxnMgrDbg("after update", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  WithTxn(txn1,
          QueryShowResult(*bustub, _var, _txn, query, IntResult{{4, 4, 4}}));
  WithTxn(txn_ref, QueryShowResult(*bustub, _var, _txn, query, empty_table));
  WithTxn(txn1, CheckUndoLogNum(*bustub, _var, _txn, 0));
...
TEST(TxnExecutorTest, DISABLED_UpdateTest2)
{  // NOLINT
  ...
  WithTxn(txn0, ExecuteTxn(*bustub, _var, _txn,
                           "INSERT INTO table2 VALUES (1, 1, 1)"));
  WithTxn(txn0, CommitTxn(*bustub, _var, _txn));
  TxnMgrDbg("after insert and commit", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  auto txn1 = BeginTxn(*bustub, "txn1");
  auto txn_ref = BeginTxn(*bustub, "txn_ref");
  ...
  WithTxn(txn1,
          QueryShowResult(*bustub, _var, _txn, query, IntResult{{1, 2, 1}}));
  WithTxn(txn_ref,
          QueryShowResult(*bustub, _var, _txn, query, IntResult{{1, 1, 1}}));
...
{  // NOLINT
  fmt::println(stderr,
               "--- UpdateTestWithUndoLog: update applied on a version chain "
               "with undo log ---");
  auto bustub = std::make_unique<BustubInstance>();
  auto empty_table = IntResult{};
  Execute(*bustub, "CREATE TABLE table2(a int, b int, c int)");
  ...
  WithTxn(txn00, ExecuteTxn(*bustub, _var, _txn,
                            "INSERT INTO table2 VALUES (0, 0, 0)"));
  WithTxn(txn00, CommitTxn(*bustub, _var, _txn));
  auto txn_ref_0 = BeginTxn(*bustub, "txn_ref_0");
  auto txn01 = BeginTxn(*bustub, "txn01");
  WithTxn(txn01, ExecuteTxn(*bustub, _var, _txn,
                            "UPDATE table2 SET a = 1, b = 1, c = 1"));
  WithTxn(txn01, CommitTxn(*bustub, _var, _txn));
  TxnMgrDbg("after insert, update, and commit", bustub->txn_manager_.get(),
  ...
  WithTxn(txn1,
          QueryShowResult(*bustub, _var, _txn, query, IntResult{{1, 2, 1}}));
  WithTxn(txn_ref_0,
          QueryShowResult(*bustub, _var, _txn, query, IntResult{{0, 0, 0}}));
  WithTxn(txn_ref_1,
          QueryShowResult(*bustub, _var, _txn, query, IntResult{{1, 1, 1}}));
  WithTxn(txn1, CheckUndoLogColumn(*bustub, _var, _txn, 1));
  fmt::println(stderr, "B: 2nd update");
...
{  // NOLINT
  {
    fmt::println(
        stderr,
        "--- UpdateConflict1: simple case, insert and two txn update it ---");
    auto bustub = std::make_unique<BustubInstance>();
    Execute(*bustub, "CREATE TABLE table1(a int, b int, c int)");
    auto table_info = bustub->catalog_->GetTable("table1");
    auto txn0 = BeginTxn(*bustub, "txn0");
    ...
    WithTxn(txn0, CommitTxn(*bustub, _var, _txn));
    auto txn_ref = BeginTxn(*bustub, "txn_ref");
    TxnMgrDbg("after initialize", bustub->txn_manager_.get(), table_info,
              table_info->table_.get());
    auto txn1 = BeginTxn(*bustub, "txn1");
    auto txn2 = BeginTxn(*bustub, "txn2");
    WithTxn(txn1, ExecuteTxn(*bustub, _var, _txn, "UPDATE table1 SET a = 1"));
    TxnMgrDbg("after 1st update", bustub->txn_manager_.get(), table_info,
              table_info->table_.get());
    WithTxn(txn2,
            ExecuteTxnTainted(*bustub, _var, _txn, "UPDATE table1 SET b = 2"));
    TxnMgrDbg("after txn tainted", bustub->txn_manager_.get(), table_info,
              table_info->table_.get());
    WithTxn(txn1, CommitTxn(*bustub, _var, _txn));
    TxnMgrDbg("after commit", bustub->txn_manager_.get(), table_info,
              table_info->table_.get());
    WithTxn(txn_ref,
            QueryShowResult(*bustub, _var, _txn, "SELECT * FROM table1",
                            IntResult{{0, 0, 0}}));
    TableHeapEntryNoMoreThan(*bustub, table_info, 1);
  }
  {
    fmt::println(stderr,
                 "--- UpdateConflict2: complex case with version chain ---");
    auto bustub = std::make_unique<BustubInstance>();
    Execute(*bustub, "CREATE TABLE table1(a int, b int, c int)");
    auto table_info = bustub->catalog_->GetTable("table1");
    auto txn0 = BeginTxn(*bustub, "txn0");
    ...
    auto txn_ref = BeginTxn(*bustub, "txn_ref");
    WithTxn(txn1, ExecuteTxn(*bustub, _var, _txn,
                             "UPDATE table1 SET b = 233 WHERE a = 0"));
    WithTxn(txn1, CommitTxn(*bustub, _var, _txn));
    WithTxn(txn2, ExecuteTxn(*bustub, _var, _txn,
                             "UPDATE table1 SET b = 2333 WHERE a = 1"));
    TxnMgrDbg("after updates", bustub->txn_manager_.get(), table_info,
              table_info->table_.get());
    WithTxn(txn3, ExecuteTxnTainted(*bustub, _var, _txn,
                                    "UPDATE table1 SET b = 2 WHERE a = 0"));
    TxnMgrDbg("after txn3 tainted", bustub->txn_manager_.get(), table_info,
              table_info->table_.get());
    WithTxn(txn4, ExecuteTxnTainted(*bustub, _var, _txn,
                                    "UPDATE table1 SET b = 2 WHERE a = 1"));
    TxnMgrDbg("after txn4 tainted", bustub->txn_manager_.get(), table_info,
              table_info->table_.get());
    WithTxn(txn2, CommitTxn(*bustub, _var, _txn));
    TxnMgrDbg("after commit", bustub->txn_manager_.get(), table_info,
              table_info->table_.get());
    WithTxn(txn_ref,
            QueryShowResult(*bustub, _var, _txn, "SELECT * FROM table1",
                            IntResult{{0, 0, 0}, {1, 1, 1}}));
    auto txn5 = BeginTxn(*bustub, "txn5");
    WithTxn(txn5, QueryShowResult(*bustub, _var, _txn, "SELECT * FROM table1",
                                  IntResult{{0, 233, 0}, {1, 2333, 1}}));
    TableHeapEntryNoMoreThan(*bustub, table_info, 2);
  }
}

TEST(TxnExecutorTest, DISABLED_GarbageCollection)
{  // NOLINT
  auto bustub = std::make_unique<BustubInstance>();
  auto empty_table = IntResult{};
  Execute(*bustub, "CREATE TABLE table1(a int, b int, c int)");
  ...
  WithTxn(txn2,
          ExecuteTxn(*bustub, _var, _txn, "UPDATE table1 SET a = a + 10"));
  WithTxn(txn2, QueryShowResult(
                    *bustub, _var, _txn, query,
                    IntResult{{10, 0, 0}, {11, 1, 1}, {12, 2, 2}, {13, 3, 3}}));
  WithTxn(txn2, CommitTxn(*bustub, _var, _txn));
  BumpCommitTs(*bustub, 2);
  ...
  WithTxn(txn3,
          ExecuteTxn(*bustub, _var, _txn, "DELETE FROM table1 WHERE a = 21"));
  WithTxn(txn3, QueryShowResult(*bustub, _var, _txn, query,
                                IntResult{{20, 0, 0}, {12, 2, 2}, {13, 3, 3}}));
  WithTxn(txn3, CommitTxn(*bustub, _var, _txn));
  BumpCommitTs(*bustub, 2);
  ...
  WithTxn(txn_watermark_at_0,
          QueryShowResult(*bustub, _var, _txn, query, empty_table));
  WithTxn(
      txn_watermark_at_1,
      QueryShowResult(*bustub, _var, _txn, query,
                      IntResult{{0, 0, 0}, {1, 1, 1}, {2, 2, 2}, {3, 3, 3}}));
  ...
  TxnMgrDbg("after garbage collection", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  fmt::println(stderr, "B: second GC");
  GarbageCollection(*bustub);
  TxnMgrDbg(
      "after garbage collection (yes, we call it twice without doing "
      "anything...)",
      bustub->txn_manager_.get(), table_info, table_info->table_.get());
  WithTxn(txn_watermark_at_0,
          EnsureTxnExists(*bustub, _var, txn_watermark_at_0_id));
  WithTxn(txn_watermark_at_1,
          EnsureTxnExists(*bustub, _var, txn_watermark_at_1_id));
  WithTxn(txn_watermark_at_2,
          EnsureTxnExists(*bustub, _var, txn_watermark_at_2_id));
  WithTxn(txn_watermark_at_3,
          EnsureTxnExists(*bustub, _var, txn_watermark_at_3_id));
  ...
  TxnMgrDbg("after garbage collection", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  WithTxn(txn_watermark_at_0,
          EnsureTxnGCed(*bustub, _var, txn_watermark_at_0_id));
  WithTxn(txn_watermark_at_1,
          EnsureTxnExists(*bustub, _var, txn_watermark_at_1_id));
  WithTxn(txn_watermark_at_2,
          EnsureTxnExists(*bustub, _var, txn_watermark_at_2_id));
  ...
  WithTxn(txn_watermark_at_0,
          EnsureTxnGCed(*bustub, _var, txn_watermark_at_0_id));
  WithTxn(txn_watermark_at_1,
          EnsureTxnGCed(*bustub, _var, txn_watermark_at_1_id));
  WithTxn(txn_watermark_at_2,
          EnsureTxnExists(*bustub, _var, txn_watermark_at_2_id));
  WithTxn(txn_watermark_at_3,
          EnsureTxnExists(*bustub, _var, txn_watermark_at_3_id));
  ...
  WithTxn(txn_watermark_at_1,
          EnsureTxnGCed(*bustub, _var, txn_watermark_at_1_id));
  WithTxn(txn_watermark_at_2,
          EnsureTxnGCed(*bustub, _var, txn_watermark_at_2_id));
  WithTxn(txn_watermark_at_3,
          EnsureTxnExists(*bustub, _var, txn_watermark_at_3_id));
  WithTxn(txn_a, EnsureTxnGCed(*bustub, _var, txn_a_id));
  WithTxn(txn_b, EnsureTxnGCed(*bustub, _var, txn_b_id));
  ...
  WithTxn(txn_watermark_at_2,
          EnsureTxnGCed(*bustub, _var, txn_watermark_at_2_id));
  WithTxn(txn_watermark_at_3,
          EnsureTxnGCed(*bustub, _var, txn_watermark_at_3_id));
  WithTxn(txn_a, EnsureTxnGCed(*bustub, _var, txn_a_id));
  WithTxn(txn_b, EnsureTxnGCed(*bustub, _var, txn_b_id));
  WithTxn(txn2, EnsureTxnGCed(*bustub, _var, txn2_id));
  WithTxn(txn3, EnsureTxnGCed(*bustub, _var, txn3_id));
...
TEST(TxnExecutorTest, DISABLED_GarbageCollectionWithTainted)
{  // NOLINT
  auto empty_table = IntResult{};
  auto bustub = std::make_unique<BustubInstance>();
  Execute(*bustub, "CREATE TABLE table1(a int, b int, c int)");
  ...
  WithTxn(txn5,
          ExecuteTxn(*bustub, _var, _txn, "DELETE FROM table1 WHERE a = 12"));
  WithTxn(txn5, ExecuteTxnTainted(*bustub, _var, _txn,
                                  "DELETE FROM table1 WHERE a = 11"));
  WithTxn(txn6, ExecuteTxnTainted(*bustub, _var, _txn,
                                  "DELETE FROM table1 WHERE a = 11"));
  TxnMgrDbg("after txn5 + txn6 tainted", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
  GarbageCollection(*bustub);
  TxnMgrDbg("after garbage collection", bustub->txn_manager_.get(), table_info,
            table_info->table_.get());
