...
public:
   ...
   *    - Basically there should be three steps to perform a lock upgrade in
   * general
   ...
   *
   *    A lock request being upgraded should be prioritized over other waiting
   ...
   *
   *    You probably want to consider which type of lock to directly apply on
   * table when implementing executor later
   */
