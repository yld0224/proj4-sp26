...
PostgresParser::PostgresParser()
    : success(false), parse_tree(nullptr), error_message(""), error_location(0)
{
}
...
vector<duckdb_libpgquery::PGSimplifiedToken> PostgresParser::Tokenize(
...
PostgresParser::~PostgresParser() { duckdb_libpgquery::pg_parser_cleanup(); }
