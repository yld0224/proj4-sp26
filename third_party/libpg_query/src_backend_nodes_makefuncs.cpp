 ...
 */
PGAExpr* makeAExpr(PGAExpr_Kind kind, PGList* name, PGNode* lexpr,
                   PGNode* rexpr, int location)
{
 ...
 */
PGAExpr* makeSimpleAExpr(PGAExpr_Kind kind, const char* name, PGNode* lexpr,
                         PGNode* rexpr, int location)
{
  PGAExpr* a = makeNode(PGAExpr);
...
/*
 * makeNullConst -
 *	  creates a PGConst node representing a NULL of the specified
 *type/typmod
 *
 ...
 */
PGDefElem* makeDefElemExtended(const char* nameSpace, const char* name,
                               PGNode* arg, PGDefElemAction defaction,
                               int location)
{
  PGDefElem* res = makeNode(PGDefElem);
 ...
 *
 */
PGGroupingSet* makeGroupingSet(GroupingSetKind kind, PGList* content,
                               int location)
{
