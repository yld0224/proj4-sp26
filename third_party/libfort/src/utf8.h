...
#define utf8_null 0
  ...
  // Similar to utf8dup, except that at most n bytes of src are copied. If src
  // is longer than n, only n bytes are copied and a null byte is added.
  //
  ...
  // address of the utf8 codepoint after the current one in str.
  utf8_nonnull utf8_weak void* utf8codepoint(
      const void* utf8_restrict str, utf8_int32_t* utf8_restrict out_codepoint);

  // Returns the size of the given codepoint in bytes.
  utf8_weak size_t utf8codepointsize(utf8_int32_t chr);

  // Write a codepoint to the given string, and return the address to the next
  // place after the written codepoint. Pass how many bytes left in the buffer
  // to n. If there is not enough space for the codepoint, this function returns
  // null.
