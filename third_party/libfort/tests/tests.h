...
#define assert_str_equal(str1, str2) d_assert_str_equal("Test", str1, str2)
...
#define assert_string_equal(str1, str2) \
  assert_str_equal(str1.c_str(), str2.c_str())

#ifdef __cplusplus
extern "C"
{
#endif
  void run_test_suite(const char* test_suite_name, int n_tests,
