...
int set_test_properties_as_default(void)
{
  ...
  status = status && fort::char_table::default_props().set_cell_text_align(
                         fort::text_align::right);

  status =
      status && fort::char_table::default_props().set_cell_bottom_padding(1);
  ...
  status =
      status && fort::char_table::default_props().set_cell_right_padding(1);
  status =
      status && fort::char_table::default_props().set_cell_empty_str_height(1);
