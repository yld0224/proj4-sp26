...
// Like C++11's std::thread, but with a reduced API, and works on Windows with
// MSVC2010+. Wraps std::thread on other OSes. Perhaps the most significant
// departure between std::thread and this mini-library is that join() is called
// implicitly in the destructor, if the thread is joinable. The thread callback
...
struct ArgWrapper
{
  ...
  ArgWrapper(T&& a1, U&& a2, V&& a3)
      : arg1(std::forward<T>(a1)),
        arg2(std::forward<U>(a2)),
        arg3(std::forward<V>(a3))
  {
  }
  template <typename TCallback>
  void callCallback(TCallback&& callback) const
  {
    std::forward<TCallback>(callback)(std::move(arg1), std::move(arg2),
                                      std::move(arg3));
  }
};
...
struct ArgWrapper<TArg1, TArg2, void>
{
  ...
  ArgWrapper(T&& a1, U&& a2)
      : arg1(std::forward<T>(a1)), arg2(std::forward<U>(a2))
  {
  }
  template <typename TCallback>
  void callCallback(TCallback&& callback) const
...
struct ArgWrapper<TArg1, void, void>
{
  ...
  void callCallback(TCallback&& callback) const
  {
    std::forward<TCallback>(callback)(std::move(arg1));
  }
};

template <>
struct ArgWrapper<void, void, void>
{
  template <typename TCallback>
  void callCallback(TCallback&& callback) const
  {
...
class SimpleThread
{
  ...
  SimpleThread(SimpleThread&& other) : thread(other.thread)
  {
  ...
  explicit SimpleThread(TCallback&& callback)
  {
    auto wrapper = new CallbackWrapper<TCallback, details::ArgWrapper<>>(
        std::forward<TCallback>(callback), details::ArgWrapper<>());
    startThread(
        wrapper,
        &CallbackWrapper<TCallback, details::ArgWrapper<>>::callAndDelete);
  }
  ...
  explicit SimpleThread(TCallback&& callback, TArg1&& arg1)
  {
    ...
    startThread(
        wrapper,
        &CallbackWrapper<TCallback, details::ArgWrapper<TArg1>>::callAndDelete);
  }
  ...
  {
    auto wrapper =
        new CallbackWrapper<TCallback, details::ArgWrapper<TArg1, TArg2>>(
            std::forward<TCallback>(callback),
            details::ArgWrapper<TArg1, TArg2>(std::forward<TArg1>(arg1),
                                              std::forward<TArg2>(arg2)));
    startThread(
        wrapper,
        &CallbackWrapper<TCallback,
                         details::ArgWrapper<TArg1, TArg2>>::callAndDelete);
  }
  ...
  {
    auto wrapper =
        new CallbackWrapper<TCallback,
                            details::ArgWrapper<TArg1, TArg2, TArg3>>(
            std::forward<TCallback>(callback),
            details::ArgWrapper<TArg1, TArg2, TArg3>(
    ...
    startThread(
        wrapper,
        &CallbackWrapper<TCallback, details::ArgWrapper<TArg1, TArg2,
                                                        TArg3>>::callAndDelete);
  }
